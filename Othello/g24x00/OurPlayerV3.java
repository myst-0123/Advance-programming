...
public class OurPlayerV3 extends ap24.Player {
  ...
  public OurPlayerV3(Color color) {
    this(MY_NAME, color, new MyEval2(), 9);
  }

  public OurPlayerV3(String name, Color color, MyEval2 eval, int depthLimit) {
    super(name, color);
    this.eval = eval;
  ...
  public OurPlayerV3(String name, Color color, int depthLimit) {
